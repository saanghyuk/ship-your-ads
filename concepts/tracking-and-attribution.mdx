...
| **Adjust** | Strong fraud prevention, privacy-first, owned by AppLovin | Gaming, fraud-sensitive apps | Custom pricing |
| **Branch** | Best deep linking + attribution combo | Apps needing deep links | Free tier available |
| **Airbridge** | Strong SKAN support, multi-touch, cost-effective | Growth-stage apps, Korean market | Competitive pricing, free tier |
...
**Providers:** Branch, AppsFlyer (OneLink), Adjust, Airbridge
...
<Steps>
  ...
  <Step title="Get an MMP when you scale to 2+ platforms">
    An MMP provides the single source of truth you need when multiple platforms are all claiming credit. Start with free tiers from AppsFlyer, Branch, or Airbridge.
  </Step>
