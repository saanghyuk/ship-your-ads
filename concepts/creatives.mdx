...
```mermaid
graph TD
    A["Brand Name / Profile + Sponsored Label"] --> B["Primary Text / Body Copy\n'Your main message here...'"]
    B --> C["Visual Asset\n(Image, Video, Carousel)\nLargest section — first thing users notice"]
    C --> D["Headline + Description\nBold text grabs attention;\nsupporting text adds context"]
    D --> E["Call to Action Button\n'Install Now' · 'Learn More' · 'Shop Now'"]
    E --> F["Destination\nApp Store · Website · Landing Page"]
