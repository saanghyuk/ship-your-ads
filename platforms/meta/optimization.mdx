...
├── Ad Set 1: Lookalike 1% (US) - $20/day [original winner]
├── Ad Set 2: Lookalike 1% (UK) - $15/day [new]
├── Ad Set 3: Lookalike 3-5% (US) - $15/day [new]
└── Ad Set 4: Interest-based (Fitness) - $15/day [new]
```
