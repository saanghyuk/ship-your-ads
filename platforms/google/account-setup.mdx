...
```mermaid
graph TD
    Acct["Google Ads Account"] --> C1["Campaign 1:<br/>Search - Brand Keywords"]
    Acct --> C2["Campaign 2:<br/>Search - Non-Brand Keywords"]
    Acct --> C3["Campaign 3:<br/>Display - Retargeting"]
    Acct --> C4["Campaign 4:<br/>Display - Prospecting (later)"]

    C1 --> AG1["Ad Group 1: Brand name variations<br/>Keywords: your brand name,<br/>'your brand name app'<br/>Ads: Brand-focused ad copy"]

    C2 --> AG2["Ad Group 1: Category keywords<br/>Keywords: 'habit tracker app',<br/>'daily routine app'"]
    C2 --> AG3["Ad Group 2: Problem keywords<br/>Keywords: 'how to build habits',<br/>'track daily habits'"]
    C2 --> AG4["Ad Group 3: Competitor keywords<br/>Keywords: 'competitor name alternative'"]

    C3 --> AG5["Ad Group 1: All website visitors<br/>Audience: Website visitors (last 30 days)<br/>Ads: Retargeting display ads"]

    C4 --> AG6["Ad Group 1: Interest-based<br/>Audience: In-market audiences<br/>Ads: Awareness display ads"]
```
