...
│       ├── Keywords: [your brand name], "your brand name app"
│       └── Ads: Brand-focused ad copy
│
├── Campaign 2: Search - Non-Brand Keywords
│   ├── Ad Group 1: Category keywords
│   │   ├── Keywords: "habit tracker app," "daily routine app"
│   │   └── Ads: Category-focused ad copy
│   ├── Ad Group 2: Problem keywords
│   │   ├── Keywords: "how to build habits," "track daily habits"
│   │   └── Ads: Problem-focused ad copy
│   └── Ad Group 3: Competitor keywords
│       ├── Keywords: "competitor name alternative"
│       └── Ads: Comparison ad copy
│
├── Campaign 3: Display - Retargeting
│   └── Ad Group 1: All website visitors
│       ├── Audience: Website visitors (last 30 days)
│       └── Ads: Retargeting display ads
│
└── Campaign 4: Display - Prospecting (later)
    └── Ad Group 1: Interest-based
