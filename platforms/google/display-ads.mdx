...
├── Ad Group 1: All Visitors (last 30 days)
│   ├── Audience: All website visitors
│   ├── Exclusion: Converters
│   ├── Bid: Base bid
│   └── Ad message: "Remember us? Come back and check out..."
│
├── Ad Group 2: Product Page Visitors (last 14 days)
│   ├── Audience: Visited product/pricing pages
│   ├── Exclusion: Converters
│   ├── Bid: Higher bid (warmer audience)
│   └── Ad message: "Still interested? Here is a special offer..."
│
├── Ad Group 3: Cart Abandoners (last 7 days)
│   ├── Audience: Added to cart but did not purchase
│   ├── Exclusion: Converters
│   ├── Bid: Highest bid (hottest audience)
│   └── Ad message: "You left something in your cart! Complete your order..."
│
└── Ad Group 4: Past Customers (last 180 days)
    ├── Audience: Converted users
    ├── Bid: Medium bid
    └── Ad message: "Welcome back! Check out what is new..."
```
