...
graph TD
    ...
    A --> A1["Audience: All website visitors\nExclude: Converters\nBid: Base\nMessage: 'Remember us? Come back...'"]
    B --> B1["Audience: Visited product/pricing pages\nExclude: Converters\nBid: Higher (warmer)\nMessage: 'Still interested? Special offer...'"]
    C --> C1["Audience: Added to cart, did not purchase\nExclude: Converters\nBid: Highest (hottest)\nMessage: 'You left something in your cart...'"]
    D --> D1["Audience: Converted users\nExclude: None\nBid: Medium\nMessage: 'Welcome back! What is new...'"]
