...
graph TD
    ...
    AG1 --> K1["'habit tracker app'<br/>'daily habit tracker'<br/>'habit tracking app'"]
    AG2 --> K2["'daily routine app'<br/>'morning routine tracker'<br/>'routine planner app'"]
    AG3 --> K3["'goal tracking app'<br/>'daily goals app'<br/>'track my goals'"]
```
