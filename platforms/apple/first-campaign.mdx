...
```mermaid
graph TD
    A["Launch Basic or Advanced Campaign"] --> B["Collect Data<br/>(5-7 days)"]
    B --> C["Review Search Terms Report"]
    C --> D["Increase bids on<br/>high-converting keywords"]
    C --> E["Pause or reduce bids on<br/>low-converting keywords"]
    C --> F["Add negative keywords<br/>for irrelevant terms"]
    D --> G["Repeat Weekly"]
    E --> G
    F --> G
