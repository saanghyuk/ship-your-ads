...
graph TD
    ...
    B -->|"Yes"| C{"Do people actively search for\napps like yours in the App Store?"}
    C -->|"Yes, definitely"| D["Apple Search Ads ✅\n(Easiest setup, highest intent)"]
    C -->|"Not really / Not sure"| E["Meta Ads ✅\n(Best all-around choice)"]
    B -->|"Android only or Both"| F{"Is your app visual,\nfun, or entertainment-focused?"}
    F -->|"Yes, very visual"| G{"Is your target audience\nunder 30?"}
    G -->|"Yes"| H["TikTok Ads ✅\n(Great reach with young users)"]
    G -->|"No / Mixed ages"| E
    F -->|"No, it solves a specific problem"| I{"Would people Google\na solution like yours?\n(e.g., 'best budget app')"}
    I -->|"Yes, people search for this"| J["Google Ads ✅\n(Capture existing demand)"]
    I -->|"Not really"| E
```
